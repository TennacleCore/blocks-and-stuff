...
object VanillaPlacementRules : VanillaRuleset<PlacementGroup, Function<Block, BlockPlacementRule>>() {
    ...
    ): PlacementGroup = PlacementGroup(blockGroup, valueFunction)
}
